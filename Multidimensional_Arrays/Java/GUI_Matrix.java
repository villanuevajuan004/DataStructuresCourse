...
/**
 * This class represents the behavior of the Graphic User Interface for Matrix Exercises
 * @author MSc. Carlos Andres Sierra, PhD. student
 */

public class GUI_Matrix extends JApplet {
	...
	private int delay_time = 250; //Delay time of each screen change
